Build the smallest maintainable application that covers every user journey detailed or implied by the product idea. Minimize implementation complexity, not coverage, and do not add capabilities the idea does not justify.
